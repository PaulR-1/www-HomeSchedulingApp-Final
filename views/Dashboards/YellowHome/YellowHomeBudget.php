...
$homePagePrefix = "YellowHome";
$homeDisplayName = "Yellow Home";
$homeBodyClass = "dashboard-red dashboard-yellow";
$homeBudgetBarAllocatedColor = "#d9cf76";
$homeBudgetBarSpentColor = "#c8bd3f";
$homeBudgetPieColors = ["#c8bd3f", "#d4ca5d", "#dfd77c", "#e9e49a", "#f4f1b9"];

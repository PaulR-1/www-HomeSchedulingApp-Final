...
$homeBudgetBarAllocatedColor = defined("HOME_BUDGET_BAR_ALLOCATED_COLOR") ? HOME_BUDGET_BAR_ALLOCATED_COLOR : "#dd7076";
$homeBudgetBarSpentColor = defined("HOME_BUDGET_BAR_SPENT_COLOR") ? HOME_BUDGET_BAR_SPENT_COLOR : "#b3484e";
$homeBudgetPieColors = defined("HOME_BUDGET_PIE_COLORS") ? HOME_BUDGET_PIE_COLORS : ["#b3484e", "#d7646b", "#ea8b91", "#f2b2b5", "#f8d5d7"];
